# Day 12b - Public Azure DNS

## 1. Objective

### Lab Objective (Portal)
Create a public DNS zone in Azure DNS, add A/CNAME records, and (if a domain is available) walk through the delegation steps at the registrar. Maps to the Networking domain.

### Bicep Objective
Write Bicep for a public DNS zone and a couple of record sets inside it.
