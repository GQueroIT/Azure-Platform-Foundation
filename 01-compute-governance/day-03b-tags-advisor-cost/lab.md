...
Apply tags to a resource group and its resources through the Portal, and review Azure Advisor's current recommendations for the subscription. Maps to the Identities and Governance domain.

### Bicep Objective
Write Bicep that applies a consistent tag object to a resource group and a resource deployed inside it.
