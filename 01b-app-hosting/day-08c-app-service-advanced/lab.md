# Day 08c - App Service - Certificates, Custom Domains, Backup, and VNet Integration

## 1. Objective

### Lab Objective (Portal)
Bind a custom domain and a managed certificate to Day 07's App Service, and enable VNet integration, through the Portal. Maps to the Compute domain.

### Bicep Objective
Write Bicep for the certificate/hostname binding resources, and document VNet integration and backup configuration.
